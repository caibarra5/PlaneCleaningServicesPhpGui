            ...
            <tbody>
                ...
                ?>
                    ...
                    <td><?php printf("%s", $row[0]); ?></td>
                        ...
                        <td><a href="update_personnel_interface.php?PEssn=<?php echo $row[0] ?>">Update</a></td>
                        <td><a href="delete_personnel.php?PEssn=<?php echo $row[0] ?>">Delete</a></td>
                    </tr>
                <?php
                }
                ?>
